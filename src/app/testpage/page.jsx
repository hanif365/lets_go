            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                <button
                  ...
                  className="text-[18px] lg:text-[24px] register_btn w-full flex justify-center items-center px-10 py-8 relative border uppercase font-semibold  leading-none overflow-hidden bg-[#070B39] rounded-md text-white cursor-pointer tracking-[0.1em]"
                >
